...
//(changed countDeclsAndUses call to buildCrossReferences)
...
public class P1 {    
  ...
  main(String args[]) throws java.io.IOException {
	...
	//print out full name and student ID number
	System.out.println("Denzil Stefen Showers - student ID: 9062589552");
	System.out.println("CS536 - Programming Assignment 1"+"\n");
    ...
    //  to the root of the AST (abstract syntax tree) the parser builds
    try {
    ...
    System.out.println ("\n\nHere is an analysis of identifier declarations and uses for "+
    		args[0]+ ":");
    //commented out countDeclsAndUses
