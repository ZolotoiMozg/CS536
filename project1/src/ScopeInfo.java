//TODO:
/**
 * This contains class definitions for the data structures and utility routines 
 * used to gather declaration and use counts.  You will need to update it to 
 * process and store identifier cross reference information.
 */

//will not have linked list of scopes, but...
//will have linked list of IDinfos and linked hash tables
