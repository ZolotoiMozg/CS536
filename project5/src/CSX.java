...
public class CSX {
  ...
  main(String args[]) throws java.io.IOException,  Exception {
    ...
    // Updated to handle ASTs rooted by classNodes
    ...
    if (ok) {
        ...
        // We'll place the name of the class we are generating in a file 
    	//"build.properties". This file can be accessed by build.xml to get the 
    	//class name we're translating
    	//File to which build propertiese will be generated
        PrintStream	propertiesFile;
    	...
    	if (ok) {
           ...
           System.out.println("CSX compilation halted due to code generation "
           		+ "errors.");
        }
